...
// received from the action server. It just // prints a message indicating a
...
int main(int argc, char** argv)
{
  ...
  client.sendGoal(goal, &doneCb, &activeCb, &feedbackCb); // sends the goal 
  // to the action server, specifying which
